...
/**
 * Wifi reset button task reacts to a button event by sending a message
...
void wifi_reset_button_task(void *pvParam)
{
	for (;;)
	{
		...
		{
			ESP_LOGI(TAG,"WIFI RESET BUTTON INTERRUPT OCCUERD");
